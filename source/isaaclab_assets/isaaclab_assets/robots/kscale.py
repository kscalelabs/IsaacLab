...
_INIT_JOINT_POS = {
    ...
    "dof_right_knee_04": math.radians(-24.0),
    "dof_right_ankle_02": math.radians(14.0),
    "dof_left_hip_pitch_04": math.radians(10.0),
    "dof_left_hip_roll_03": math.radians(0.0),
    "dof_left_hip_yaw_03": 0.0,
    "dof_left_knee_04": math.radians(24.0),
    "dof_left_ankle_02": math.radians(-14.0),
}
...
WALKING_JOINT_POS = {
    ...
    "dof_left_elbow_02": math.radians(-90.0),
    "dof_left_wrist_00": 0.0,
    "dof_right_hip_pitch_04": math.radians(0.0),
    "dof_right_hip_roll_03": math.radians(0.0),
    "dof_right_hip_yaw_03": 0.0,
    "dof_right_knee_04": math.radians(0.0),
    "dof_right_ankle_02": math.radians(0.0),
    "dof_left_hip_pitch_04": math.radians(0.0),
    "dof_left_hip_roll_03": math.radians(0.0),
    "dof_left_hip_yaw_03": 0.0,
    "dof_left_knee_04": math.radians(0.0),
    "dof_left_ankle_02": math.radians(0.0),
}
