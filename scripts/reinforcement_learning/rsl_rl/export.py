...
def main():
    ...
    NUM_JOINTS = 20#len(env.unwrapped.scene["robot"].data.joint_names)
    ...
    _INIT_JOINT_POS = torch.zeros(20)#action_term._offset
    ...
    def _step_fn(
        ...
        actions_scaled = torch.zeros(20)
        # actions_scaled[20] = command[11]
        # actions_scaled[21] = command[17]
        ...
        actions_scaled[1:20:4] = command[11:16]
